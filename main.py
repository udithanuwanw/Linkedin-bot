...
while True:
        ...
        sleep(5)
        driver.get('https://www.linkedin.com/jobs/search/?currentJobId=4156932801&distance=25.0&f_E=1&f_TPR=r86400&geoId=100446352&keywords=software%20engineer%20intern&origin=JOB_SEARCH_PAGE_JOB_FILTER')
        sleep(5)
